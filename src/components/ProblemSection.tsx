...
import { AlertCircle, Clock, Scale, BellOff, ArrowDownRight } from "lucide-react";
          ...
          {challenges.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-slate-50 rounded-2xl p-6 sm:p-7 border border-slate-200 flex flex-col justify-between hover:border-slate-300 transition-all shadow-2xs"
              >
                <div>
                  <div className="w-12 h-12 rounded-xl bg-rose-100/80 text-rose-700 flex items-center justify-center mb-5">
                ...
                <div className="mt-6 pt-5 border-t border-slate-200/80 bg-white/70 -mx-6 -mb-6 p-5 rounded-b-2xl">
